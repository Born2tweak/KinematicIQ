...
At the original `8d8a77d` snapshot, M73 and M78 kept lunge research-only and no implementation existed. The later `f49558e` seam remains unavailable; dataset acquisition still needs separate approval, and availability remains a later decision. Consequently:
