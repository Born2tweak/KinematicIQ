...
No lunge implementation existed at the audited `8d8a77d` snapshot. The later `f49558e` experimental seam is unavailable; this handbook authorizes neither production implementation nor public availability.
