...
> **Expanded-10 Revision 4 authority (2026-07-21):** KQ-001 through KQ-007 are complete with repository-bound evidence. The immediate dependency-ready Phase A frontier is KQ-008 (inflection/replan schema) and KQ-010 (traceability validator); KQ-016 and KQ-017 are also ready as bounded Phase B corpus-freeze work. The additive ID migration maps all 16 ADRs and all 15 Phase 4 evidence records without rewriting history or promoting historical evidence to current validation. KQ-008 through KQ-015 remain the committed Phase A queue before scheduler authority is granted. Squat remains the only available protocol; Forward Lunge and every additional movement remain unavailable until their preregistered release gates produce `GATE_PASS`.
