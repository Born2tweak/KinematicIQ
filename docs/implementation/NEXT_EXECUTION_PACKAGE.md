...
> **Expanded-10 Revision 4 authority (2026-07-21):** KQ-001 through KQ-010, KQ-012, and KQ-014 are complete with repository-bound evidence. The dependency-ready Phase A frontier is KQ-011 (stale-authority detector) and KQ-013 (checkpoint generator), with capacity scheduling selecting KQ-011 next; KQ-016 and KQ-017 are also ready as bounded Phase B corpus-freeze work. The research-question registry is intentionally empty until a real decision-critical question opens, while a labeled orchestration-only fixture verifies question, sources, budget, synthesis, and decision-impact semantics. KQ-011, KQ-013, and KQ-015 remain before the Phase A integration gate can pass. Squat remains the only available protocol; Forward Lunge and every additional movement remain unavailable until their preregistered release gates produce `GATE_PASS`.
