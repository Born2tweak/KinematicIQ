...
> **Expanded-10 Revision 4 authority (2026-07-21):** KQ-001 through KQ-010 and KQ-014 are complete with repository-bound evidence. The dependency-ready Phase A frontier is KQ-011 through KQ-013, with capacity scheduling selecting KQ-012 (research-question workflow) next; KQ-016 and KQ-017 are also ready as bounded Phase B corpus-freeze work. Typed traceability link and orphan validation now fails closed, while canonical Expanded-10 scientific coverage remains explicitly `bootstrap_partial` until the planned evidence, claim, metric, gate, and protocol registries are populated by their owning milestones. KQ-011 through KQ-013 and KQ-015 remain before the Phase A integration gate can pass. Squat remains the only available protocol; Forward Lunge and every additional movement remain unavailable until their preregistered release gates produce `GATE_PASS`.
