...
> **Expanded-10 Revision 4 authority (2026-07-21):** KQ-001 through KQ-012 and KQ-014 are complete with repository-bound evidence. KQ-013 (checkpoint generator) is the sole dependency-ready Phase A node and the next scheduled milestone; KQ-016 and KQ-017 are also ready as bounded Phase B corpus-freeze work. Phase 2, Phase 3, and Phase 4 roadmaps/handoffs now carry enforced historical-authority notices pointing to the master roadmap, milestone registry, and compiled program status. KQ-013 and KQ-015 remain before the Phase A integration gate can pass. Squat remains the only available protocol; Forward Lunge and every additional movement remain unavailable until their preregistered release gates produce `GATE_PASS`.
