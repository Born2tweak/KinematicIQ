...
> **Expanded-10 Revision 4 authority (2026-07-21):** KQ-001 through KQ-005 and KQ-007 are complete with repository-bound evidence. The immediate dependency-ready Phase A frontier is KQ-006 (stable decision/evidence links), KQ-008 (inflection/replan schema), and KQ-010 (traceability validator); KQ-016 and KQ-017 are also ready as bounded Phase B corpus-freeze work. The canonical execution policy now drives Wave 1 capacity and enforces the dedicated branch, verified auto-push, reversible recovery, exact human interruptions, and unaffected-ready-queue continuation while forbidding force-push, direct master merge, and automatic deployment. KQ-006 through KQ-015 remain the committed Phase A queue before scheduler authority is granted. Squat remains the only available protocol; Forward Lunge and every additional movement remain unavailable until their preregistered release gates produce `GATE_PASS`.
