...
> **Expanded-10 Revision 4 authority (2026-07-21):** KQ-001 through KQ-009 and KQ-014 are complete with repository-bound evidence. The dependency-ready Phase A frontier is KQ-010 through KQ-013, with capacity scheduling selecting KQ-010 (traceability validator) next; KQ-016 and KQ-017 are also ready as bounded Phase B corpus-freeze work. The critical-path scheduler is now an accepted executable contract backed by the canonical execution policy and generated Wave 1 manifest. KQ-010 through KQ-013 and KQ-015 remain before the Phase A integration gate can pass. Squat remains the only available protocol; Forward Lunge and every additional movement remain unavailable until their preregistered release gates produce `GATE_PASS`.
