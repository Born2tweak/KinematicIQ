...
> **Expanded-10 Revision 4 authority (2026-07-21):** KQ-001 through KQ-005 are complete with repository-bound evidence. The immediate dependency-ready Phase A frontier is KQ-006 (stable decision/evidence links), KQ-007 (execution policy), and KQ-010 (traceability validator); KQ-016 and KQ-017 are also ready as bounded Phase B corpus-freeze work. Historical M00–P4-M14 records are retained with explicit incomplete, blocked, human-gated, and fail-closed dispositions and never substitute for current KQ proof. KQ-006 through KQ-015 remain the committed Phase A queue before scheduler authority is granted. Squat remains the only available protocol; Forward Lunge and every additional movement remain unavailable until their preregistered release gates produce `GATE_PASS`.
